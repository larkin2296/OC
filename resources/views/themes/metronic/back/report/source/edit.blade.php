        ...
        <form data-url="{{ route('admin.source.store') }}" data-method="post" data-type="json" class="form-horizontal form-bordered form-row-stripped" >
            ...
            <div class="form-body">
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input type="date" value="{{old('accept_report_date',$source->accept_report_date)}}" name="accept_report_date" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3">研究方案编号</label>
                    <div class="col-md-9">
                        <input type="text" {{old('solution_number',$source->solution_number)}} name="solution_number" class="form-control">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <textarea name="remark" rows="5" class="form-control">{{old('remark',$source->remark)}}</textarea>
                    </div>
                </div>
                <div class="form-group">
