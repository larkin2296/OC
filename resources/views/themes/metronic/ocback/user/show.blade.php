				...
				<div class="container">
					<div class="friend-grids">
						<div class="col-md-4 friend-grid">
							<img src="{{URL::asset('images/p.png')}}">
						...
						<div class="col-md-4 friend-grid">
							<img src="{{URL::asset('images/p1.png')}}">
							<h4>Friendly Agents</h4>
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla convallis egestas rhoncus. Donec facilisis fermentum sem, ac viverra ante luctus vel.</p>
						</div>
						<div class="col-md-4 friend-grid">
							<img src="{{URL::asset('images/p2.png')}}">
							<h4>Buy or Rent</h4>
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla convallis egestas rhoncus. Donec facilisis fermentum sem, ac viverra ante luctus vel.</p>
						</div>
						<div class="clearfix"></div>
						...
						<div class="col-md-6 offer-grid">
							<div class="offer-grid1">
								...
								<div class="offer1">
									<div class="offer-left">
										<a href="single.html" class="mask"><img src="{{URL::asset('images/p3.jpg')}}" class="img-responsive zoom-img" alt=""/></a>
									</div>
							...
							<div class="col-md-6 offer-grid">
								<div class="offer-grid1">
									...
									<div class="offer1">
										<div class="offer-left">
											<a href="single.html" class="mask"><img src="{{URL::asset('images/p4.jpg')}}" class="img-responsive zoom-img" alt=""/></a>
									</div>
										<div class="offer-right">
					...
					<div class="offer-grids">
						<div class="col-md-6 offer-grid">
							<div class="offer-grid1">
								...
								<div class="offer1">
									<div class="offer-left">
										<a href="single.html" class="mask"><img src="{{URL::asset('images/p5.jpg')}}" class="img-responsive zoom-img" alt=""/></a>
									</div>
									<div class="offer-right">
							...
							<div class="col-md-6 offer-grid">
								<div class="offer-grid1">
									...
									<div class="offer1">
										<div class="offer-left">
											<a href="single.html" class="mask"><img src="{{URL::asset('images/p6.jpg')}}" class="img-responsive zoom-img" alt=""/></a>
									</div>
										<div class="offer-right">
					...
					<div class="offer-grids">
						<div class="col-md-6 offer-grid">
							<div class="offer-grid1">
								...
								<div class="offer1">
									<div class="offer-left">
										<a href="single.html" class="mask"><img src="{{URL::asset('images/p7.jpg')}}" class="img-responsive zoom-img" alt=""/></a>
									</div>
									<div class="offer-right">
							...
							<div class="col-md-6 offer-grid">
								<div class="offer-grid1">
									...
									<div class="offer1">
										<div class="offer-left">
											<a href="single.html" class="mask"><img src="{{URL::asset('images/p8.jpg')}}" class="img-responsive zoom-img" alt=""/></a>
									</div>
										<div class="offer-right">
					...
					<div class="container">
						...
						<div class="feature-grids">
							<div class="col-md-3 feature-grid">
								<img src="{{URL::asset('images/f1.jpg')}}" class="img-responsive" alt="/">
								<h5>Villa in Hialeah, Dade</h5>
								<p>Lorem ipsum dolor sit amet, consectetuer  elit,… <a href="#">Know More</a></p>
								<span>$2,500 Per Month</span>
							</div>
							<div class="col-md-3 feature-grid">
								<img src="{{URL::asset('images/f2.jpg')}}" class="img-responsive" alt="/">
								<h5>401 Biscayne Boulevard</h5>
								<p>Lorem ipsum dolor sit amet, consectetuer  elit,… <a href="#">Know More</a></p>
								<span>$7,500 Per Month</span>
							</div>
							<div class="col-md-3 feature-grid">
								<img src="{{URL::asset('images/f3.jpg')}}" class="img-responsive" alt="/">
								<h5>154 Southwest  Terra</h5>
								<p>Lorem ipsum dolor sit amet, consectetuer  elit,… <a href="#">Know More</a></p>
								<span>$9,500 Per Month</span>
							</div>
							<div class="col-md-3 feature-grid">
								<img src="{{URL::asset('images/f4.jpg')}}" class="img-responsive" alt="/">
							...
							<div id="owl-demo" class="owl-carousel">
								<div class="item">
									<div class="col-md-2 testmonial-img">
										<img src="{{URL::asset('images/t1.png')}}" class="img-responsive" alt=""/>
									</div>
								...
								<div class="item">
									<div class="col-md-2 testmonial-img">
										<img src="{{URL::asset('images/t2.png')}}" class="img-responsive" alt=""/>
									</div>
									<div class="col-md-10 testmonial-text">
										<p>Lorem ipsum dolor sit amet, offendit volutpat sea ex, at omnium scripta pro, at omnium scripta pro, ei mea oratio malorum forensibus. ei mea oratio malorum forensibus. Sed ei omnes laoreet posidonium ei mea oratio malorum forensibus.</p>
								...
								<div class="item">
									<div class="col-md-2 testmonial-img">
										<img src="{{URL::asset('images/t3.png')}}" class="img-responsive" alt=""/>
									</div>
									<div class="col-md-10 testmonial-text">
										<p>Lorem ipsum dolor sit amet, offendit volutpat sea ex, at omnium scripta pro, at omnium scripta pro, ei mea oratio malorum forensibus. ei mea oratio malorum forensibus. Sed ei omnes laoreet posidonium ei mea oratio malorum forensibus.</p>
